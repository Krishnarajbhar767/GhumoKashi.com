    ...
    const blogData = [
        {
            ...
            description:
                "Varanasi, the city of temples and ghats, is a spiritual hub where history and devotion merge beautifully along the banks of the Ganges.",
            author: "Ghoomo Kashi",
            date: "2025-02-28",
            time: "10:30 AM",
        },
        {
            ...
            description:
                "Ayodhya, one of the holiest cities in India, is famous for its ancient temples and the grand Ram Mandir.",
            author: "Ghoomo Kashi",
            date: "2025-02-27",
            time: "02:15 PM",
        },
        {
            ...
            description:
                "Prayagraj is renowned for the Triveni Sangam, where three sacred rivers meet, and for hosting the world's largest religious gathering, the Kumbh Mela.",
            author: "Ghoomo Kashi",
            date: "2025-02-26",
            time: "09:45 AM",
        },
        {
            ...
            description:
                "Naimisharanya, a divine forest, is a sacred place where sages compiled Hindu scriptures, making it an important spiritual destination.",
            author: "Ghoomo Kashi",
            date: "2025-02-25",
            time: "05:30 PM",
        },
        {
            ...
            description:
                "Chitrakoot is a serene and spiritual town where Lord Rama spent a significant part of his exile. It is known for its temples, ghats, and divine atmosphere.",
            author: "Ghoomo Kashi",
            date: "2025-02-24",
            time: "04:00 PM",
        },
        {
            ...
            description:
                "Mathura and Vrindavan are sacred places associated with Lord Krishna’s birth and childhood. These cities are famous for temples, festivals, and devotional culture.",
            author: "Ghoomo Kashi",
            date: "2025-02-23",
            time: "08:20 AM",
        },
...
function BlogPost({ item }) {
    ...
    return (
        <div
            className="w-full bg-gray-200 p-5 mt-5 rounded-lg h-fit flex flex-col gap-1 
        ...
        >
            <div className="h-fit py-2">
                ...
                <div className="flex flex-col py-2">
                    ...
                    <h1 className="w-full text-[1rem] text-gray-700 my-2">
                        {item.title}
                    </h1>
            ...
            <p
                ...
                className="border-b-2 border-[#e8464b] pr-5 w-fit capitalize font-semibold cursor-pointer 
