    ...
    <section className="bg-gray-100">
      ...
      >
        ...
        <div className=" w-[70%] py-10 flex flex-col items-start text-white gap-2  ">
          <h2 className="font-semibold text-[20px]  lg:text-[35px] border-b-5 border-[#e8464b] pr-10 py-2  ">About Us</h2>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-600 text-lg text-center max-w-3xl mx-auto">
          Welcome to our travel services! We specialize in providing the best travel experiences in Prayagraj, Ayodhya, Varanasi and Gaya. Whether you need car rentals, hotel bookings, or guided tours, we ensure a smooth and unforgettable journey.
        </p>
      ...
      >
        ...
        <div className=" lg:w-[70%] w-[90%] py-10 flex flex-col items-center text-white gap-2  ">
          <h2 className="font-bold text-center w-ful lg:text-[25px] text-[18px]">Experience Prayagraj , Ayodhya Varanasi and Gaya with Our Premium Travel Services</h2>

          <p className="text-center text-[16px]
          ">
            Embark on a memorable journey to Prayagraj , Ayodhya Varanasi and Gaya with our premium travel services. We offer hassle-free car rentals, straightforward hotel bookings, and flexible pickup locations to suit your needs. Our user-friendly booking process and clear pricing ensure a smooth travel experience. Plus, with 24/7 customer support, we’re always ready to assist you. Choose us to handle the details while you enjoy the rich heritage and vibrant culture of Prayagraj , Ayodhya Varanasi and Gaya.
          </p>
