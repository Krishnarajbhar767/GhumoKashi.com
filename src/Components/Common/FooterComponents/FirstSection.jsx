...
function FirstSection() {
    return (
        <div className="w-full flex flex-col gap-5 lg:px-5 px-1 py-5">
            ...
            <h2>
                At <b>Ghoomo Kashi</b>, we are passionate about helping you explore the rich heritage and vibrant culture of Prayagraj , Ayodhya Varanasi and Gaya.
            </h2>
            <h3 className="w-full text-[20px] font-semibold">Our Social Media</h3>
